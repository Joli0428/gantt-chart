...
export const COPY = {
  ...
  taskListEmptyHint: "新增後會出現在這裡，左側拖曳可調整順序",
  addTaskFirst: "新增第一個任務",
  addTaskMore: "新增任務",
  taskModalAddTitle: "新增任務",
  taskModalEditTitle: "編輯任務",
  taskModalAddConfirm: "確認新增",
  taskModalEditConfirm: "儲存變更",
  taskAdded: "任務已新增 ✓",
  taskUpdated: "任務已更新 ✓",
  taskListEditHint: "左側拖曳排序",
  exportShare: "分享 / 儲存",
  exportDownload: "下載圖片",
  exportShareDone: "已開啟分享選單 ✓",
  exportDownloadDone: "圖片已下載 ✓",
  rangeClamped: "日期區間最多顯示 120 天，已自動調整",
  resetButton: "重新開始",
